...
if !exists("tex_no_math")
 ...
 syn match texBadMath		"\\end\s*{\s*\(eqn\|eqns\|IEEEeqnarray\|align\|alignat\|displaymath\|displaymath\|eqnarray\|equation\|flalign\|gather\|math\|multline\|xalignat\)\*\=\s*}"
...
if !exists("tex_no_math")
 ...
 call TexNewMathZone("N","eqns",1)
 call TexNewMathZone("O","eqn",1)
